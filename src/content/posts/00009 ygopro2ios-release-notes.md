...
- **更新内容**：
  ...
  • 优化 MyCard 登录流程，支持账号资料、头像与战绩展示。
  • 优化 MyCard 匹配流程，支持取消匹配、登录状态恢复与异常重试。
  • 新增卡牌库、禁限卡表和卡牌文本的在线同步，支持失败回滚与无需重启热加载。
  • 新增超先行卡列表、卡图预览及资源下载入口。
  • 新增自定义游戏分辨率设置。
  • 优化弱网环境下的下载重试、文件校验与更新稳定性。
  • 更新到 26.07 表的卡片、禁卡表资源
