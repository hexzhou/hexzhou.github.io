...
## 📦 IPA 下载
### 2026-07-12
- **下载地址**：[koishi.pro](https://cdntx.moecube.com/ex/koishipro2-hex/release/KoishiPro2-1.036.2-Tulipa-2607.ipa)  
- **更新内容**：  
本次更新聚焦于账号安全、卡牌资料同步和超先行卡体验。  
  1. 优化 MyCard 登录流程，支持账号资料、头像与战绩展示。
  2. 优化 MyCard 匹配流程，支持取消匹配、登录状态恢复与异常重试。
  3. 新增卡牌库、禁限卡表和卡牌文本的在线同步，支持失败回滚与无需重启热加载。
  4. 新增超先行卡列表、卡图预览及资源下载入口。
  5. 新增自定义游戏分辨率设置。
  6. 优化弱网环境下的下载重试、文件校验与更新稳定性。
  7. 更新到 26.07 表的卡片、禁卡表资源
